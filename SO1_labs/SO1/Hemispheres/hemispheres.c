...
bool isNorthernHemisphere(double y) {
...
bool isSouthernHemisphere(double y) {
...
int main() {
	...
	if (isNorthernHemisphere(y)) {
		printf("\nThe location is in Northern hemisphere");
	}
	else if(isSouthernHemisphere(y)){
		printf("\nThe location is in Southern hemisphere");
	}
	else {
		printf("\nThe location is in the equator");
	}
